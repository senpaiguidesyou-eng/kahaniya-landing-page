  ...
  return (
    ...
    >
      <div className="container mx-auto px-2 md:px-6 lg:px-12 py-6 flex items-center justify-between">
        <Link href="/" className="block relative h-[35px] w-[140px] md:h-12 md:w-48 ml-2 md:ml-0 z-50">
          <img
      ...
      {isOpen && (
        <div
          className="fixed inset-0 z-40 flex flex-col pt-32 px-6 h-screen w-screen"
        ...
        >
          <div className="flex flex-col gap-8 text-center">
            <Link
              ...
              className="text-2xl font-serif text-white hover:text-[#f1c60d] transition-colors"
            >
              Home
            </Link>
            <Link
            ...
            <ContactModal>
              <button
                className="text-2xl font-serif text-[#f1c60d] hover:text-white transition-colors"
              >
                Contact
              </button>
            </ContactModal>
