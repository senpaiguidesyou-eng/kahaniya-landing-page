        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="space-y-4 text-center">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#b79c5a]/30 to-black border border-[#b79c5a]/30 flex items-center justify-center mx-auto shadow-lg shadow-[#b79c5a]/30">
                <feature.icon className="w-8 h-8 text-[#b79c5a]" />
              </div>
