...
export function ContactModal({ children }: ContactModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-md bg-black/80 backdrop-blur-xl border-zinc-800 p-0 overflow-hidden gap-0">
                <VisuallyHidden>
                    <DialogTitle>Contact Kahaania</DialogTitle>
                </VisuallyHidden>
                <div className="p-8 md:p-10 flex flex-col items-center justify-center text-center space-y-8">
                    ...
                    >
                        ...
                        <span className="font-medium tracking-wide">Continue on WhatsApp</span>
                    </a>
                </div>
            </DialogContent>
        </Dialog>
